...
echo "************************************************************" >> output.txt
cat /etc/sysconfig/nftables.conf >> output.txt  2>&1
echo $'\n \n' >> output.txt
...
echo "************************************************************" >> output.txt
selinux_bootloader >> output.txt  2>&1
echo $'\n \n' >> output.txt
...
echo "************************************************************" >> output.txt
wirelessint_disabled >> output.txt  2>&1
echo $'\n \n' >> output.txt
...
echo "************************************************************" >> output.txt
auditdProcess_enabled >> output.txt  2>&1
echo $'\n \n' >> output.txt
...
echo "************************************************************" >> output.txt
backlogLimitSufficient >> output.txt  2>&1
echo $'\n \n' >> output.txt
...
echo "************************************************************" >> output.txt
shellTOConfigured >> output.txt  2>&1
echo $'\n \n' >> output.txt
